...
#
# Finds the QDMI-Device-Example library (local C++ QDMI binding) and the
# QDMI C headers, both installed under external/installed/.
#
# Imported variables:
#   QDMI_DEVICE_EXAMPLE_FOUND        - True if found
#   QDMI_DEVICE_EXAMPLE_INCLUDE_DIR  - Directory containing qdmi.hpp
#   QDMI_DEVICE_EXAMPLE_LIBRARIES    - Full path to libqdmi_cpp
...
find_path(QDMI_DEVICE_EXAMPLE_INCLUDE_DIR
    NAMES qdmi.hpp
    PATHS "${QDMI_DEVICE_EXAMPLE_ROOT}/include"
    NO_DEFAULT_PATH
)
...
find_library(QDMI_DEVICE_EXAMPLE_LIBRARY
    NAMES qdmi_cpp
    PATHS "${QDMI_DEVICE_EXAMPLE_ROOT}/lib"
          "${QDMI_DEVICE_EXAMPLE_ROOT}/lib64"
    NO_DEFAULT_PATH
)

include(FindPackageHandleStandardArgs)
find_package_handle_standard_args(QDMIDeviceExample
    REQUIRED_VARS QDMI_DEVICE_EXAMPLE_LIBRARY QDMI_DEVICE_EXAMPLE_INCLUDE_DIR QDMI_INCLUDE_DIR
)

if(QDMI_DEVICE_EXAMPLE_FOUND)
    set(QDMI_DEVICE_EXAMPLE_INCLUDE_DIRS ${QDMI_DEVICE_EXAMPLE_INCLUDE_DIR} ${QDMI_INCLUDE_DIR})
    set(QDMI_DEVICE_EXAMPLE_LIBRARIES ${QDMI_DEVICE_EXAMPLE_LIBRARY})
endif()

mark_as_advanced(QDMI_INCLUDE_DIR QDMI_DEVICE_EXAMPLE_INCLUDE_DIR QDMI_DEVICE_EXAMPLE_LIBRARY)
message(STATUS "QDMI_DEVICE_EXAMPLE_ROOT        = ${QDMI_DEVICE_EXAMPLE_ROOT}")
message(STATUS "QDMI_INCLUDE_DIR                = ${QDMI_INCLUDE_DIR}")
message(STATUS "QDMI_DEVICE_EXAMPLE_INCLUDE_DIR = ${QDMI_DEVICE_EXAMPLE_INCLUDE_DIR}")
message(STATUS "QDMI_DEVICE_EXAMPLE_LIBRARY     = ${QDMI_DEVICE_EXAMPLE_LIBRARY}")
