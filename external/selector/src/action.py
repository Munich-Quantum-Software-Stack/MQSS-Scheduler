...
mqss_action_logger = logging.getLogger("mqss-action")
mqss_action_logger.setLevel(logging.INFO)
...
class Action:
    ...
    pass_type: PassType
    transpile_pass: (
        list[qiskit_BasePass]
        | Callable[..., list[qiskit_BasePass]]
        | Callable[
            ...,
          Callable[..., tuple[Any, ...]],
        ]
...
class DeviceDependentAction(Action):
    ...
    do_while: Callable[[dict[str]], bool] | None = None
